            ...
            <div className="mx-auto pr-20 pl-20 bg-background shadow rounded-lg pb-8">
                ...
                <div className="">
                    ...
                    <div>
                        ...
                        <h2 className="text-xl ">
                            Choose from a selection of services to enrich your
                            stay with us.
                        </h2>
                        <div className="grid lg:grid-cols-4 gap-5 pt-5 pb-16">
                            <Card className="">
                                ...
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Order some flowers directly to a loved
                                        one's room.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                            ...
                            <Card className="">
                                ...
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Feeling threatened? Order security to
                                        your location.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                            ...
                            <Card className="">
                                ...
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Order your prescribed medications to
                                        your room.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
